...
public class ReconciliationProcessFactory {
    ...
    @Autowired
    private ManyToOneReconciliationProcess manyToOneReconciliationProcess; // Add this line
    ...
    public ReconciliationProcess getReconciliationProcess(String matchingConfigurationId) {
        ...
        if (matchingConfigurationOpt.isPresent()) {
            ...
            switch (matchingType) {
                ...
                case many_to_one: // Add this case for many-to-one
                    return manyToOneReconciliationProcess;
                // Add other cases if there are more reconciliation types
                default:
