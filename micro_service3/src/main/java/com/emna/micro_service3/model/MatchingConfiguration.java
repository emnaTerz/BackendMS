...
public class MatchingConfiguration {
    ...
    public MatchingConfiguration(String id, String name, String sourceId, String targetId, MatchingType matchingType, Date creationDate, Date updateDate, List<Date> scheduleList) {
        this.id = id;
